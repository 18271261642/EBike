...
import com.bonlala.ebike.action.SingleClick;
import com.bonlala.ebike.app.AppAdapter;
import com.bonlala.ebike.app.AppApplication;
import com.bonlala.ebike.manager.PickerLayoutManager;
...
public final class DateDialog {
    ...
    public static final class Builder
        ...
        private ShapeTextView yearBorderTv,monthBorderTv,dayBorderTv;
        ...
        public Builder(Context context, int startYear, int endYear) {
            ...
            setCustomView(R.layout.dialog_date_select_layout);
            setTitle("生日");
            ...
            yearBorderTv = findViewById(R.id.yearBorderTv);
            monthBorderTv = findViewById(R.id.monthBorderTv);
            dayBorderTv = findViewById(R.id.dayBorderTv);
        ...
        //设置是否是白色背景
        public Builder setBgColor(boolean isWhite){

            setBgAlpha(isWhite);

            if(isWhite){
                yearBorderTv.getShapeDrawableBuilder().setStrokeColor(Color.parseColor("#F2F2F7")).intoBackground();
                monthBorderTv.getShapeDrawableBuilder().setStrokeColor(Color.parseColor("#F2F2F7")).intoBackground();
                dayBorderTv.getShapeDrawableBuilder().setStrokeColor(Color.parseColor("#F2F2F7")).intoBackground();
            }
            return this;
        }
        ...
        private static final class PickerAdapter extends AppAdapter<String> {
            ...
            private final class ViewHolder extends AppAdapter<?>.ViewHolder {
                ...
                public void onBindView(int position) {
                    ...
                    mPickerView.setTextColor(AppApplication.getInstance().isDateSelectWhite() ? Color.BLACK : Color.WHITE);
                }
            }
        }
    }
