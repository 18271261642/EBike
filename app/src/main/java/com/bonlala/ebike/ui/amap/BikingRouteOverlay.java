        ...
        if (mRouteLine.getAllStep() != null
            ...
            for (BikingRouteLine.BikingStep step : mRouteLine.getAllStep()) {
                ...
                if (watPoints != null) {
                    ...
                    overlayList.add(new PolylineOptions().points(points) .dottedLine(true).width(20).customTexture(BitmapDescriptorFactory
                            .fromAssetWithDpi("Icon_road_blue_arrow.png"))
