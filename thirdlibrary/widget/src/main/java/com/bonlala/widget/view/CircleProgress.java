package com.bonlala.widget.view;
...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {Color.parseColor("#DFFFEA"), Color.parseColor("#30D158"), Color.WHITE};
    //当前进度，[0.0f,1.0f]
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mAnimTime = typedArray.getInt(R.styleable.CircleProgressBar_animTime, 0);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
       ...
       // Log.d(TAG, "onSizeChanged: w = " + w + "; h = " + h + "; oldw = " + oldw + "; oldh = " + oldh);
        ...
        updateArcPaint();
//        Log.e(TAG, "onSizeChanged: 控件大小 = " + "(" + w + ", " + h + ")"
...
//                + ";圆的外接矩形 = " + mRectF.toString());
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(decimalFormat.format(end), mCenterPoint.x, mValueOffset, mValuePaint);

       // canvas.drawText(String.format(mPrecisionFormat, mValue), mCenterPoint.x, mValueOffset, mValuePaint);

        if (mHint != null) {
            canvas.drawText(mHint.toString(), mCenterPoint.x, mHintOffset-MiscUtil.dipToPx(mContext,10), mHintPaint);
        }

        if (mUnit != null) {
            canvas.drawText(mUnit.toString(), mCenterPoint.x, mUnitOffset+MiscUtil.dipToPx(mContext,10), mUnitPaint);
        }
    }
    ...
    private void updateArcPaint() {
        // 设置渐变
        int[] mGradientColors = {Color.parseColor("#DFFFEA"), Color.parseColor("#30D158"), Color.parseColor("#DFFFEA")};
